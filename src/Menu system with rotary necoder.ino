...
int menuCounter = 0; // counts the clicks of the rotary encoder between menu
...
const int RotaryCLK = 21 ;  // CLK pin on the rotary encoder
const int RotaryDT = 25;   // DaTa pin on the rotary encoder
const int PushButton = 33; // Button to enter/exit menu
...
void pushButton() {
  ...
  case 0:
    menu1_selected =
        !menu1_selected; // we change the status of the variable to the opposite
    break;
